...
if(!isset($_SESSION['admin'])){
   $_SESSION['message']="this section is reserved for admin"; 
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="index.php"><i class=" fa fa-suitcase"></i>Profile</a></li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="index.php?viewBrands">View Brands</a></li>
						<li><a href="index.php?insert_brands">Insert Brand</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="index.php?viewOrders">All orders</a></li>
						<li><a href="index.php?viewUsers">List of Users</a></li>
